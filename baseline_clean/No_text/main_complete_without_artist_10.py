...
def remove_cols(cols_doesnt_love_me, numerical_cols, categorical_cols ):
    cols_to_remove = []
    new_numeric_cols = [col for col in numerical_cols if col not in cols_doesnt_love_me]
    new_categorical_cols = [col for col in categorical_cols if col not in cols_doesnt_love_me]
    return new_numeric_cols, new_categorical_cols
...
def main():
    ...
    N_cols,COL_TF_IDF = remove_cols(cols_doesnt_love_me, N_cols, COL_TF_IDF)
    print("After removing some columns that doesn't love me, for TF-IDF embbedings you are selecteing this columns:" )
    print("-->", COL_TF_IDF)
    if NUMERICCOlS:
        print("After removing some columns that doesn't love me, for numeric cols you are selecteing this columns:" )
        print("-->", N_cols)
    ...
    for embedding_type in embb_types:
        ...
        output_dir = f"outputs_without_artist{out}/10/{embedding_type}"
