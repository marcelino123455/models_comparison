...
def elimnate_index(X, path= "faltantes_according_token.json"):
    elminar_ = get_array(path)
    print("Se eliminarán los siguientes indices", elminar_)
    ...
    print(f"Shape filtrado  X: {X_filtrado.shape}")
    return X_filtrado
...
def main():
    ...
    csv_path = f"{path_DATA}/spotify_dataset_pseudo_labeling.csv"
    ...
    for embedding_type in embb_types:
        ...
        if CATEGORICALCOLS: 
            ...
            if embedding_type == 'tfidf':
                ...
                CAT_EMB = elimnate_index(CAT_EMB)
