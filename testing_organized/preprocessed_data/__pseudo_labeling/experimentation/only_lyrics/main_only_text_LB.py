...
def load_TFIDF_embbedings(csv_path, sample_size=None, columns_tf_idfizable = ['text'], max_features = 5000, steaming= False, remove_stopwords = True, faltantes_path = "faltantes_according_token.json"):
    ...
    # Ya no realizamos la eliminacion
    # the new dataset is new and elminated this indexes
...
def main():
    ...
    for embedding_type in embb_types:
        ...
        if embedding_type == 'lyrics_bert':
            ...
            X = elimnate_index(X) # Consistencia coon los embbeidngs

            # X, _ignore = elimnate_index(X, y.copy()) # Consistencia coon los embbeidngs
            ...
            # Is not necessary the elimination
        ...
        output_dir = f"outputs_only_text{out}/2/{embedding_type}"
