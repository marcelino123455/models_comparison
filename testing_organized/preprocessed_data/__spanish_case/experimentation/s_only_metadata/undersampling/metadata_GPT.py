...
def main():
    ...
    T = ['text']
    M=["artist", "genre", "title_songs_new"] 
    ...
    CAT_LOW = ["title_songs_new"] 
    CAT_HIGH = ["artist", "genre"]
    ...
    N_C = ["lyrics_word_count", "popularity", "duration_ms"]
    ...
    npy_path = f"{path_DATA}/LB_M/LB_fuss/lb_khipu_M.npy"
    ...
    for embedding_type in embb_types:
        if TEXT: 
            if embedding_type == 'lyrics_bert':
                ...
                npy_path_gpt = f"{path_DATA}/gpt_M_np/gpt_fussioned/gpt_M_np.npy"
        ...
        if CATEGORICALCOLS: 
            ...
            if embedding_type == 'tfidf':
                ...
                npy_path_cat = f"{path_DATA}/LB_M/LB_fuss/lb_khipu_M.npy"
                ...
                # npy_path_gpt_cat = f"{path_DATA}/gpt_M/gpt_fussioned/gpt_M.npy"
                npy_path_gpt_cat = f"{path_DATA}/gpt_M_np/gpt_fussioned/gpt_M_np.npy"
