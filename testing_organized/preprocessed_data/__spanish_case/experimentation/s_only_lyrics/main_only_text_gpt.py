...
def main():
    ...
    if COL_TF_IDF == B:
        ...
        cols_type = "T"
        # npy_path = "../../data/embbedings_khipu/lb_khipu_A.npy" 
        npy_path = f"{path_DATA}/LB_T/LB_fuss/lb_khipu_T.npy"
    ...
    for embedding_type in embb_types:
        ...
        if embedding_type == 'lyrics_bert':
            ...
            npy_path_gpt = f"{path_DATA}/gpt_T/gpt_fussioned/gpt_T.npy"
            print(f"\n{'#' * 50}")
            print(f"Running experiment with {embedding_type.upper()} embeddings")
        ...
        output_dir = f"outputs_only_text_pseudo{out}/2/{embedding_type}"
