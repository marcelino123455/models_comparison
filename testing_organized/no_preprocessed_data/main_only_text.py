...
def main():
    ...
    SCALED = True
    STEAMING = False # NO aply preprocessing 
    # Remember this variable control the preprocessing
    # we dont change since a lot of code has this variable
    REMOVESTW = True
    NUMERICCOlS = False
    MAX_FEATURES = 5000
    ...
    if COL_TF_IDF == B:
        ...
        cols_type = "T"
        # npy_path = "../../data/embbedings_khipu/lb_khipu_A.npy" 
        # Load the path of lyrics Bert witouth preprocessing
        
        
        npy_path = f"{path_DATA}/new_embbedings_khipu/LB_fuss/lb_khipu_T_NP.npy" 
    ...
    for embedding_type in embb_types:
        ...
        output_dir = f"outputs_only_text{out}/0/{embedding_type}"
